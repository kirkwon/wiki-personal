...
The book provides a suite of analytical tools for systematic market creation: the [[strategy-canvas]] for mapping competitive convergence, the [[four-actions-framework-eliminate-reduce-raise-create]] (ERRC grid) for reconstructing value curves, and the [[six-paths-framework]] for reconstructing market boundaries. It emphasizes that new demand from non-customers matters more than stealing share from existing competitors, and that execution is built into strategy through [[fair-process-leadership]] and [[tipping-point-leadership-bos]].

Key case studies include Cirque du Soleil, Southwest Airlines, and Nintendo Wii, which illustrate how companies created blue oceans by redefining industry boundaries and making competition irrelevant.

## Related Concepts
- [[blue-ocean-strategy]] — the overarching framework
