---
date: 2026-04-24
title: Red Rice (Camargue/Kerala)
created: 2026-04-24
updated: 2026-04-24
type: concept
tags:
...
# Red Rice (Camargue/Kerala)

## Quick Reference

| Attribute | Value |
|-----------|-------|
| **Origin** | France (Camargue) or India (Kerala) |
| **Grain Type** | Medium to long-grain |
| **Aroma** | Earthy, nutty |
| **Texture** | Chewy, bran layer intact |
| **Amylose Content** | Medium-high |
| **Best For** | Salads, grain bowls, Kerala cuisine |
| **Preparation** | Rinse, 1:2.25 ratio, simmer 35-40 min |
| **Common Dishes** | Red rice salad, Kerala red rice, puttu |

## Overview

Red Rice (Camargue/Kerala) is France (Camargue) or India (Kerala)'s signature rice variety, known for its earthy, nutty aroma and chewy, bran layer intact texture. This rice is essential for salads, grain bowls, kerala cuisine.
...
```yaml
Region: France (Camargue) or India (Kerala)
...
The unique characteristics of Red Rice (Camargue/Kerala) come from:
...
- **Grain Length**: Medium to long-grain
- **Amylose/Amylopectin Ratio**: Medium-high
- **Aroma Compound**: Earthy, nutty
- **Color**: Natural (white, brown, black, or red depending on variety)

### Flavor Profile

- **Raw**: Earthy, nutty
- **Cooked**: Chewy, bran layer intact
...
Rinse, 1:2.25 ratio, simmer 35-40 min.
...
Red rice salad, kerala red rice, puttu.
