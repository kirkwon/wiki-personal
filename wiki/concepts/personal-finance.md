...
The comprehensive management of financial resources including budgeting, saving, investing, debt management, and retirement planning. This personal finance system encompasses comprehensive wealth management strategies including investment principles, risk management, tax optimization, and retirement planning. The content is structured to provide both conceptual understanding and practical implementation frameworks.
...
- [[the-4-buckets-framework]]: Fixed costs (50-60%), investments (10-20%), savings (5-10%), guilt-free spending (20-35%)
- [[automation-of-finances]]: Automate everything — bill payments, savings transfers, investment contributions
- [[debt-avalanche-vs-debt-snowball]]: Two strategies for paying off debt
- [[dollar-cost-averaging]]: Invest same amount monthly regardless of price
- [[the-4-percent-rule]]: Need 25x annual expenses for retirement
- [[rule-of-110]]: Age-based stock/bond allocation
...
### Income Generation
- Career advancement and salary optimization
...
1. Get employer 401(k) match (free money, guaranteed 50-100% return)
2. Open Roth IRA (tax-free growth forever)
3. Automate everything (systems beat willpower)
4. Buy index funds (VTSAX, target-date funds)
5. Negotiate salary, fees, insurance
...
- [[retirement-planning]] for long-term goals
- [[real-estate-investment]] for property strategies
- [[investment-strategies-for-life-satisfaction]] for values-aligned investing
- [[the-psychology-of-money]] for behavioral insights
- [[the-algebra-of-wealth]] for wealth-building math
- [[the-index-card-rules]] for systematic decision-making
