...
- **Default Options** – Setting beneficial options as defaults (e.g., automatic retirement savings enrollment)
- **Choice Architecture** – The way options are organized and presented affects decisions
- **Preserve Freedom** – People can still opt out; no coercion is involved
- **Works with Psychology** – Rather than fighting cognitive biases, design around them

## Applications

- Retirement savings (automatic enrollment)
- Organ donation (opt-out vs. opt-in)
- Health decisions (default healthy options)
