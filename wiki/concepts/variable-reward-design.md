...
1. ** Tribe** — Social rewards: likes, comments, followers, social validation
2. ** Hunt** — Material rewards: search results, deals, discoveries
3. ** Self** — Intrinsic rewards: mastery, completion, personal achievement

## Why Variability Matters

Predictable rewards lead to satiation — once users know what they will get, the reward loses its power. Variable rewards exploit the same neurological mechanism as gambling: the anticipation of an uncertain outcome releases dopamine, which reinforces the behavior regardless of whether the actual reward is valuable.
