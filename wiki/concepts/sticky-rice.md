...
| **Aroma** | Sweet, nutty when toasted |
| **Texture** | Very sticky, chewy, translucent when cooked |
| **Amylose Content** | 0-2% (negligible - almost all amylopectin) |
| **Best For** | Dim sum, desserts, Lao/Thai cuisine |
| **Preparation** | Soak 4+ hours, steam in bamboo basket 20-25 min |
| **Common Dishes** | Zongzi, mango sticky rice, sticky rice in bamboo, mochi |

## Overview

Sticky Rice/Glutinous Rice (糯米) is Southeast Asia's signature rice variety, known for its sweet, nutty when toasted aroma and very sticky, chewy, translucent when cooked texture. This rice is essential for dim sum, desserts, lao/thai cuisine.
...
The unique characteristics of Sticky Rice/Glutinous Rice (糯米) come from:
...
- **Grain Length**: Short to medium-grain
- **Amylose/Amylopectin Ratio**: 0-2% (negligible - almost all amylopectin)
- **Aroma Compound**: Sweet, nutty when toasted
- **Color**: Natural (white, brown, black, or red depending on variety)

### Flavor Profile

- **Raw**: Sweet, nutty when toasted
- **Cooked**: Very sticky, chewy, translucent when cooked
...
Soak 4+ hours, steam in bamboo basket 20-25 min.
...
Zongzi, mango sticky rice, sticky rice in bamboo, mochi.
