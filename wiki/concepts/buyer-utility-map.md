...
The buyer utility map pinpoints the six levers buyers value:

1. **Customer productivity** — Does the offering help the buyer do things better or faster?
2. **Fun and image** — Does it provide an emotional or aesthetic experience?
3. **Process** — Does it simplify or improve the buying or using process?
4. **Risk** — Does it reduce the buyer's risk or anxiety?
5. **Environmental friendliness** — Does it align with the buyer's environmental values?
6. **Results and outcomes** — Does it deliver superior results or outcomes?

## Six Stages of the Buyer Experience Cycle

The map evaluates utility across these stages:
