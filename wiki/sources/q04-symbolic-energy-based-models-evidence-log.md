...
date: 2026-09-13
type: source
description: "Aggregated evidence log for q04-symbolic-energy-based-models (preserved from the retired brain repo; the canonical Q-page now tracks evidence per-paper under raw/papers/)"
source: brain/ (retired 2026-09-13)
---

# q04-symbolic-energy-based-models — Evidence Log
