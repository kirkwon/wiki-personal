...
date: 2026-09-01
type: source
description: "Aggregated evidence log for q06-agent-harness-self-improvement (preserved from the retired brain repo; the canonical Q-page now tracks evidence per-paper under raw/papers/)"
source: brain/ (retired 2026-09-13)
assembled: 2026-09-13
---

# q06-agent-harness-self-improvement — Evidence Log

> Preserved from `brain/` before retirement. The canonical Q-page guards this material out of its body; evidence is now tracked per-paper in `raw/papers/`. This page retains the aggregated view.
