...
## Domain
Personal knowledge base covering cooking, photography, personal finance, and general second brain topics for lifelong learning and reference.

## Conventions
- File names: lowercase, hyphens, no spaces (e.g., `camera-settings-guide.md`)
...
## Tag Taxonomy
Define top-level tags for the domain. Add new tags here BEFORE using them.

### Cooking & Food
- technique, recipe, ingredient, cuisine, equipment, meal-planning, nutrition, baking, fermentation, gastronomy, wok, seafood, meat, sauces, spices, herbs, coffee, tea, beverages, rice, grain, staple, asian, japanese, thai, indian, chinese, italian, spanish

### Photography
- camera, lens, lighting, composition, editing, genre, film, digital, exposure, post-processing, fundamentals

### Personal Finance
- budgeting, investing, banking, taxes, insurance, retirement, real-estate, cryptocurrency, debt, income, rmd, 401k, roth-ira

### General Knowledge & Second Brain
- productivity, learning, health, psychology, technology, books, travel, philosophy, writing, creativity, cognitive-science, decision-making, mental-models, person, behavioral-economics, cognitive-bias

### Music & Arts
- music, jazz, bebop, musicians, theory, improvisation
