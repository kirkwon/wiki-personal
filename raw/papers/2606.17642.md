...
authors: ["Pianran Guo", "Pengcheng Zhou", "Yuchen Jian", "Shuhua Chen"]
affiliations: ["Beijing University of Posts and Telecommunications", "Queen Mary University of London"]
published: 2026-06-16
tags: [papers, finance, multimodal-reasoning, memory-harness, self-evolving, agent, causal]
---
...
- [[papers/2606.09498|Self-Harness: Harnesses That Improve Themselves]] — Same paradigm (harness improvement loop), different domain (coding vs. finance)
- [[concepts/memory-tiering]] — FinAcumen's memory bank is a formalization of the tier concept
- [[projects/causal-ai-hedge-agent]] — FinAcumen's financial reasoning is directly applicable
- [[concepts/self-harness-paradigm]] — Three-stage improvement loop
