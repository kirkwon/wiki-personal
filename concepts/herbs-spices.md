...
created: '2026-04-24'
sources:
- raw/ingested/Gastronomy/Herbs & Spices/Index.md
tags:
- general
- herbs
- spices
...
```mermaid
graph LR
    A[Mint Family] --> A1[Mint - cool]
    A --> A2[Basil - sweet]
    A --> A3[Oregano - pungent]
    B[Parsley Family] --> B1[Parsley - fresh]
    B --> B2[Cilantro - citrusy]
    B --> B3[Dill - anise]
    C[Thyme Family] --> C1[Thyme - earthy]
    C --> C2[Rosemary - woodsy]
    C --> C3[Lavender - floral]
```

### Spice Pairings
```mermaid
graph LR
    A[Curry Base] --> A1[Cumin]
    A --> A2[Coriander]
    A --> A3[Turmeric]
    B[Italian Base] --> B1[Oregano]
    B --> B2[Basil]
    B --> B3[Thyme]
    C[Mexican Base] --> C1[Cumin]
    C --> C2[Chili]
    C --> C3[Paprika]
```
