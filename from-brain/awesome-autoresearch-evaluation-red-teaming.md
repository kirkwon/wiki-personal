---
type: concept
title: Awesome Autoresearch Evaluation Red Teaming
ingested_via: put_page
ingested_at: '2026-07-26T15:00:52.455Z'
...
- [Anti-Autoresearch](https://github.com/wanshuiyin/Anti-Autoresearch) - Autoresearch integrity forensics: derived from the ARIS research-agent platform, applies a three-layer audit stack (experiment-audit, result-to-claim, paper-claim+citation-audit) with cross-model adversarial review and deterministic verdict, detecting 39 hack-patterns across 7 families to flag manipulated or fabricated autoresearch results.
