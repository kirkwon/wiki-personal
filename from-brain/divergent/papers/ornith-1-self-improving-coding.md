---
type: concept
title: Ornith 1 Self Improving Coding
ingested_via: put_page
ingested_at: '2026-06-29T06:27:47.144Z'
...
This is a concrete instantiation of the [[self-harness-paradigm]]: the Weakness Mine → Harness Propose → Proposal Validate loop, implemented as RL weight updates rather than manual iteration.
...
- [[scaffold-optimization]] — the core innovation formalized as its own concept
- [[self-harness-paradigm]] — Ornith is a concrete RL-based implementation of this loop
- [[causal-ai-hedge-agent]] — P3 Skill→LoRA workstream directly benefits from scaffold co-optimization
- [[co-failure-ceiling]] — understanding ensemble limits informs when to route to Ornith vs fallback models
