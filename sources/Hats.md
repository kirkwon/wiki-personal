...
The "Hats" mental model is a conceptual tool for navigating complex situations through perspective-shifting. It provides a mental shortcut for making sense of patterns and relationships in the world. The source cross-references Edward de Bono's Six Thinking Hats framework, which includes white (facts), red (emotions), black (caution), yellow (optimism), green (creativity), and blue (process control) hats. This model is applicable across all domains as a universal framework for structured thinking.
<response>
---FILE: wiki/index.md---
---
type: summary
...
- [[six-thinking-hats---edward-de-bono]] - Six Thinking Hats source
